...
$(".characterContainer").on("click", function()
{
	...
	if(enemiesAvailable === false)
	{
		...
		var chosenCharacter = $(this);		  //(this) refers to the img-button that I clicked on
	...
	else if(enemiesAvailable === true)
	{
		...
		var chosenEnemy = $(this);						//(this) refers to the chosen enemy in the (Enemis Available To Attack)
